            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        <div>
                            <h5 class="mb-2">{{ $item->task_name }} <span id="testing{{ $item->id }}"
                                    class="badge badge-warning"> Screen Recording</span>
                                @isset($item->file_test)
                                    <a href="{{ url('document_testing/' . $item->file_test) }}" target="_blank"
                                        class="badge badge-info">Lihat Hasil Testing</a>
                                @endisset
                            </h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            @if (empty($item->comments))
                                <form action="{{ url('project_test_uat/store_uat') }}" method="post"
